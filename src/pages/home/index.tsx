  ...
  const handleOpenApp = () => {
    if (isAndroid) {
      ...
      setTimeout(() => {
        ...
        if (!document.hidden) { // document.hiddenでアプリ遷移を検知できる場合がある
      ...
      console.log("Androidデバイスではありません。");
    }
  };
      ...
      <main className={styles.main}>
        {currentUser &&
          <div>
            ...
            <button onClick={handleOpenApp} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
              アプリを開く
            </button>
